...
/obj/item/projectile/bullet/p50
	...
	damage = 88                    //Skyrat Edit
	knockdown = 100
	dismemberment = 50
	armour_penetration = 65        //Skyrat Edit: This means it will go clean through bulletproof armor and most hardsuits, it's 18000> Joules of kinetic force jfc
...
/obj/item/projectile/bullet/p50/Initialize()
	. = ..()
	SpinAnimation()
